...
public partial class api_CharBackpack : WOApiWebPage
{
    void InventoryOp(string CustomerID, string CharID, int OpCode, Int64 v1, int v2, int v3)
    {
        ...
        switch (OpCode)
        {
            ...
            // server codes
            //
            case 50: // ApiBackpackAddItem
                sqcmd.CommandText = "WZ_Backpack_SRV_AddItem";
                sqcmd.Parameters.AddWithValue("@in_ItemID", v1);
                sqcmd.Parameters.AddWithValue("@in_Slot", v2);
                break;
            case 51: // ApiBackpackRemoveItem
                sqcmd.CommandText = "WZ_Backpack_SRV_RemoveItem";
                sqcmd.Parameters.AddWithValue("@in_ItemID", v1);
                sqcmd.Parameters.AddWithValue("@in_Slot", v2);
                break;
