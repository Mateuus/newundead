...
class CMasterUserServer : public r3dNetCallback
{
  public:
	...
	bool		Validate(const GBPKT_C2M_BanPlayer_s& n) { return true; }
	bool		Validate(const GBPKT_C2M_JoinGameReq_s& n);
	bool		Validate(const GBPKT_C2M_QuickGameReq_s& n) { return true; }
	bool		Validate(const GBPKT_C2M_RentGameReq_s& n) { return true; }
	bool		Validate(const GBPKT_C2M_RentGameStr_s& n) { return true; }
