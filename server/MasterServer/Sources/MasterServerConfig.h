...
class CMasterServerConfig
{
  public:
	...
	void		 ParsePermamentGame(int gameServerId, const char* name, const char* map, const char* data,const char* pwdchar, bool ispass,bool ispre,bool isfarm , int owner,int isTop);
