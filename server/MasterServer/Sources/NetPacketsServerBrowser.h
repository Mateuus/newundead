...
struct SBPKT_G2M_ScreenShotData_s : public r3dNetPacketMixin<SBPKT_G2M_ScreenShotData>
{
	char	fname[MAX_PATH];
	//char data[500000];
	int size;
...
struct SBPKT_G2M_SendScreenShot_s : public r3dNetPacketMixin<SBPKT_G2M_SendScreenShot>
{
     WORD		dataSize;
};
