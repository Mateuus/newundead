...
#include "../../../src/EclipseStudio/Sources/VoIP/serverlib_publicdefinitions.h"
#include "./../../src/EclipseStudio/Sources/VoIP/serverlib.h"
#include "id_io.h"
...
int main() {
    ...
    serverID = createVirtualServer("TS3 SDK INFESTATION ", 9987, MAX_CLIENTS);
    ...
    /* Set server password */
    if((error = ts3server_setVirtualServerVariableAsString(serverID, VIRTUALSERVER_PASSWORD, "40779117")) != ERROR_ok) {
