...
#else
    //r3dSec_type<IDirect3DDevice9*, 0xAC8DA94A> pd3ddev;
...
public:
	...
	r3dTexture*	LoadTextureMem( void* data, D3DFORMAT texFormat = D3DFMT_UNKNOWN, bool bCheckFormat = false, int downScale = 1, int downScaleMinDim = 1, D3DPOOL pool = D3DPOOL_MANAGED, int gameResourcePool = TexMem );
