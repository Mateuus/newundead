...
void r3dDrawSphereSolid(r3dVector const & vPos, float fRadius, const r3dCamera &Cam, r3dColor24 const & clr, uint32_t dwNumSphereRings, uint32_t dwNumSphereSegments )
{
	float fDeltaRingAngle = ( D3DX_PI / dwNumSphereRings );
	float fDeltaSegAngle  = ( 2.0f * D3DX_PI / dwNumSphereSegments );
...
void r3dDrawCylinder ( const r3dCylinder & cylinder, r3dCamera &Cam, r3dColor tColor, DWORD dwNumSegments )
{
