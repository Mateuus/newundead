...
{
	//TargetTexFormat = D3DFMT_A8R8G8B;
...
r3dTexture* r3dRenderLayer::LoadTextureMem( void* data, D3DFORMAT TexFormat, bool bCheckFormat, int DownScale /*= 1*/, int DownScaleMinDim /*= 1*/, D3DPOOL Pool /*= D3DPOOL_MANAGED*/, int gameResourcePool /*= 0*/ )
{
	if(!bInited)
		return NULL;
