...
bool r3dKeyboard::IsPressed(int key)
{
...
r3dInputMappingMngr::r3dInputMappingMngr()
{
	...
	m_Mapping[KS_PRIMARY_FIRE] =			KeyboardMapping(INPUTMAP_MOUSE, r3dMouse::mLeftButton, "$HUD_Cntrl_PrimaryFire");
	m_Mapping[KS_AIM] =						KeyboardMapping(INPUTMAP_MOUSE, r3dMouse::mRightButton, "$HUD_Cntrl_Aim");

	m_Mapping[KS_MOVE_FORWARD] =			KeyboardMapping(INPUTMAP_KEYBOARD, kbsW, "$HUD_Cntrl_MoveForw");
	m_Mapping[KS_MOVE_BACKWARD] =			KeyboardMapping(INPUTMAP_KEYBOARD, kbsS, "$HUD_Cntrl_MoveBack");
	m_Mapping[KS_MOVE_LEFT] =				KeyboardMapping(INPUTMAP_KEYBOARD, kbsA, "$HUD_Cntrl_MoveLeft");
	m_Mapping[KS_MOVE_RIGHT] =				KeyboardMapping(INPUTMAP_KEYBOARD, kbsD, "$HUD_Cntrl_MoveRight");
	m_Mapping[KS_SPRINT] =					KeyboardMapping(INPUTMAP_KEYBOARD, kbsLeftShift, "$HUD_Cntrl_Sprint");
	m_Mapping[KS_JUMP] =					KeyboardMapping(INPUTMAP_KEYBOARD, kbsSpace, "$HUD_Cntrl_Jump");
	...
	m_Mapping[KS_MOVE_FORWARD_AUTORUN] =			KeyboardMapping(INPUTMAP_KEYBOARD, kbsNumLock, "$HUD_Cntrl_MoveForwToggle");

	m_Mapping[KS_TOGGLEHUD] =			KeyboardMapping(INPUTMAP_KEYBOARD, kbsF12, "$HUD_Cntrl_TurnOffHUD");
	...
	m_Mapping[KS_CHAT_CHANNEL4] =			KeyboardMapping(INPUTMAP_KEYBOARD, kbsF4, "$HUD_Cntrl_Chat4");
