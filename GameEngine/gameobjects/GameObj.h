...
enum EGameObjectType
{
	...
	OBJTYPE_Particle			= (1<<5), // particle emitter
	OBJTYPE_Sound				= (1<<6), // sound emitter
	OBJTYPE_Trees				= (1<<7), // all world trees
	OBJTYPE_ApexDestructible	= (1<<8),
	OBJTYPE_AnimMesh			= (1<<9),
	OBJTYPE_DecalProxy			= (1<<10),
	OBJTYPE_Sprite				= (1<<11),
	OBJTYPE_GameplayItem		= (1<<12),
...
public:
	...
	PrecalculatedMeshVSConsts preparedVSConsts;
public:
...
public:
	...
	int			ObjFlags;
	//	This function needed to perform additional operations during flags setting
	virtual void SetObjFlags(int objFlags) { ObjFlags |= objFlags; }
...
public:
	...
	void AppendSlicedShadowRenderables( RenderArray ( & render_arrays )[ rsCount ], int inMainFrustum, const r3dCamera& Cam );
