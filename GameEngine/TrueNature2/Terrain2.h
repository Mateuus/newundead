...
public:
	...
	virtual bool				PrepareOthographicTerrainRender() OVERRIDE;
...
private:
	...
	int PackBin( const char* dirName, const Shorts& hfShrinkedSamples, int rescaleVertexCountX, int rescaleVertexCountZ );
