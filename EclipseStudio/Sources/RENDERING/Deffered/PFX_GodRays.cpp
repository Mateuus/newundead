...
PFX_GodRays::InitImpl() /*OVERRIDE*/
{
	...
	mShadeTexture			= r3dRenderer->LoadTexture( "Data\\Shaders\\Texture\\LensDirt.dds" );
}
...
{
	//r3dRenderer->SetTex( mShadeTexture,	1 );
	...
	//r3dOutToLog("GodRaysPos %.2f %.2f \n",scr.x/dest->Width,scr.y/dest->Height);

	D3D_V( r3dRenderer->pd3ddev->SetPixelShaderConstantF( 0, (float*)vConsts, 2 ) );
	D3D_V( r3dRenderer->pd3ddev->SetPixelShaderConstantF( 1, (float*)vConsts, 2 ) );
	...
	//D3D_V( r3dRenderer->pd3ddev->GetSamplerState(1, D3DSAMP_ADDRESSU, &prevAddressU));
	//D3D_V( r3dRenderer->pd3ddev->GetSamplerState(1, D3DSAMP_ADDRESSV, &prevAddressV));

	//D3D_V( r3dRenderer->pd3ddev->SetSamplerState(1, D3DSAMP_ADDRESSU, D3DTADDRESS_BORDER));
	//D3D_V( r3dRenderer->pd3ddev->SetSamplerState(1, D3DSAMP_ADDRESSV, D3DTADDRESS_BORDER));
	//D3D_V( r3dRenderer->pd3ddev->SetSamplerState(1, D3DSAMP_BORDERCOLOR, 0));
}
