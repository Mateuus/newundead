...
extern r3dScreenBuffer* SharedShadowMap;
extern r3dScreenBuffer*	LFUpdateShadowMap;
...
extern r3dScreenBuffer* InternalScreenshotBuffer ; // NULL xcept for when "internal screenshot" is scheduled
