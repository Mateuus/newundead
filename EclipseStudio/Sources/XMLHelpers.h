...
template < bool Write > R3D_FORCEINLINE int SerializeXMLVal( const char* Name, pugi::xml_node& node, std::string* ioVal );
...
template <> R3D_FORCEINLINE int SerializeXMLVal< true > ( const char* Name, pugi::xml_node& node, std::string* ioVal ){ return SetXMLVal( Name, node, ioVal ); }
...
template <> R3D_FORCEINLINE int SerializeXMLVal< false > ( const char* Name, pugi::xml_node& node, std::string* ioVal ){ return GetXMLVal( Name, node, ioVal ); }
