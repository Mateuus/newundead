...
public:
	...
	void Fire(const r3dPoint3D& hitPos, const r3dPoint3D& muzzlerPos, const D3DMATRIX& weaponBone, GameObject* owner, const WeaponConfig* weapon, float added_delay=0);
