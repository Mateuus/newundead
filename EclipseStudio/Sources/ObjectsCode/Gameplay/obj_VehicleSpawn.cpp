...
void obj_VehicleSpawn::AppendShadowRenderables( RenderArray & rarr, const r3dCamera& Cam ) /*OVERRIDE*/
{
	if ( !g_bEditMode )
		return;
...
void obj_VehicleSpawn::SetVehicleType( const std::string& preset )
{
