...
en.type.VehiclesSound = SoundSys.GetEventIDByPath(xmlEntry.attribute("sound").value());
		...
		en.type.SwimFSound = SoundSys.GetEventIDByPath("Sounds/WarZ/PlayerSounds/PLAYER_SWIM_FAST");
		en.type.SwimSound = SoundSys.GetEventIDByPath("Sounds/WarZ/PlayerSounds/PLAYER_SWIM_NORMAL");
#endif
